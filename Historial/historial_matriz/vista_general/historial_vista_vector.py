"""
Archivo: historial_vista_vector.py 1.0.6
Descripción: Este archivo contiene el frame interno para mostrar problemas de vectores en el historial general.
"""
...
class HistorialVectorFrame(CTkFrame):
    ...
    def mostrar_historial_matriz(self):
        ...
        """
        problemas_matriz = self.historial.obtener_historial_vector()

        for i, problema in enumerate(problemas_matriz):
            # Crear sub=frame para organizar mejor cada problema
...
if __name__ == "__main__":
    ...
    historial_frame = HistorialVectorFrame(app, historial)
