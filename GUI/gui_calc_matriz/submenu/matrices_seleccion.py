...
from GUI.gui_calc_matriz.calculadoras.transpuesta_inversa_calc import MatrizCalculatorInvTranFrame
from GUI.gui_calc_matriz.calculadoras.determinante_frame import DeterminanteFrame
from GUI.gui_calc_matriz.calculadoras.cramer_frame import CramerFrame
...
class CalculadoraMatricesFrame(CTkFrame):
    def __init__(self, parent, historial, *args, **kwargs):
        ...
        self.frames = {
            ...
            'Metodo Cramer': CramerFrame(self.frame_cambiable, self.historial)
        }
