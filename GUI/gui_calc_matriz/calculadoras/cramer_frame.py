"""
Archivo: cramer_frame.py 1.0.6
Descripción: Este archivo contiene la interfáz gráfica de la calculadora del metodo de cramer.
"""
from ctkcomponents import *
from CTkToolTip import *
from Historial.historial_matriz.historial_popup.historial_popup_ui import *
from models.modelos_matriz_vector.operacion_cramer import CreadorDeCramer
...
class CramerFrame(ctk.CTkFrame):
    ...
    def __init__(self, parent, historial):
        ...
        self.label_matriz = ctk.CTkLabel(self.entrada_frame, text="Ingrese la matriz aumentada:", font=("Arial", 17))
