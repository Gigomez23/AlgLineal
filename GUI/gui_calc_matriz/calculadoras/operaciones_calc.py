...
from models.modelos_matriz_vector.clase_matriz_op_ari import *
...
from GUI.gui_calc_matriz.interfaz_entrada.entrada_matriz_esclava_identica import FrameEsclavoMatriz
