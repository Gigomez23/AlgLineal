"""
Archivo: entrada_matriz_esclava_identica.py 1.0.0
...
from GUI.interfaz_entrada.entrada_matriz_frame import FrameEntradaMatriz
    ...
    def construir_matriz_esclava(self):
        ...
        for r in range(self.filas):
            ...
            for c in range(self.columnas):
                entrada = ctk.CTkEntry(self.frame_matriz_esclava, width=50)
